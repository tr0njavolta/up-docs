...
overview](/hub/architecture) and [the database overview](/hub/db-overview). It does
...
guide](/hub/install), merge the snippet above into the `values.yaml` you are
...
Return to [the self-hosted install guide](/hub/install) to finish wiring Hub
