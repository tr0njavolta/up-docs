...
[sizing guide](/hub/sizing) covers tuning it.
:::
...
- [AWS RDS](/hub/aws-rds), which covers provisioning PostgreSQL on Amazon RDS and
...
- [Provision PostgreSQL on AWS RDS](/hub/aws-rds)
- [Install Hub against your provisioned database](/hub/install)
