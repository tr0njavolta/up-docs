...
* Added a new [Observability View in the WebUI](https://docs.upbound.io/controlplanes/uxp/concepts/observability-views/) showing dashboards with the state of the UXP installation and managed resources.
