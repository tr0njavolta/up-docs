...
topics you apply on top of the [self-hosted install](./install.md).
...
for picking a starting tier. See [Sizing](./sizing.md).
...
the UI offline. See [High availability](./high-availability.md).
...
Start with [Sizing](./sizing.md). The other four topics reference the tier it
produces.
